...
func TestDeviceString(t *testing.T) {
	tests := []struct {
		...
		{"Switch", NewSwitch(nil, &testBus{}, DeviceInfo{Address: Address{1, 2, 3}}), "Switch (01.02.03)"},
		{"Dimmer", NewDimmer(nil, &testBus{}, DeviceInfo{Address: Address{1, 2, 3}}), "Dimmer (01.02.03)"},
