...
func TestDeviceString(t *testing.T) {
	tests := []struct {
		...
		{"I1Device", newI1Device(&testBus{}, DeviceInfo{Address: Address{1, 2, 3}}), "I1 Device (01.02.03)"},
		{"I2Device", newI2Device(&testBus{}, DeviceInfo{Address: Address{1, 2, 3}}), "I2 Device (01.02.03)"},
		{"I2CsDevice", newI2CsDevice(&testBus{}, DeviceInfo{Address: Address{1, 2, 3}}), "I2CS Device (01.02.03)"},
		{"Switch", NewSwitch(&testDevice{}, &testBus{}, DeviceInfo{Address: Address{1, 2, 3}}), "Switch (01.02.03)"},
		{"Dimmer", NewDimmer(&testDevice{}, &testBus{}, DeviceInfo{Address: Address{1, 2, 3}}), "Dimmer (01.02.03)"},
