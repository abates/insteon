...
func (tl *testLinkable) RemoveLinks(...*insteon.LinkRecord) error { return nil }
func (tl *testLinkable) WriteLink(*insteon.LinkRecord) error      { return nil }
func (tl *testLinkable) AddLink(*insteon.LinkRecord) error        { return nil }
func (tl *testLinkable) AppendLink(*insteon.LinkRecord) error     { return nil }
