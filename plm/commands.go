...
var (
	...
	CmdSetConfig             = NewCommand("Set Config", 0x6b, 2, func() insteon.Payload { c := Config(0x00); return &c })
	...
	CmdGetConfig             = NewCommand("Get Config", 0x73, 4, func() insteon.Payload { c := Config(0x00); return &c })
)
