...
var commands = []commandGroup{
	...
	},
	{
		...
		Commands: []command{
			...
			{"CmdExitLinkingModeExt", "Exit Linking Mode", "Exit Linking Mode (i2cs)", 0x08, 0x00, "Insteon version 2 with checksum devices only respond to extended linking commands"},
			{"CmdEnterLinkingModeExt", "Enter Linking Mode (extended command for I2CS devices)", "Enter Linking Mode (i2cs)", 0x09, 0x00, "Insteon version 2 with checksum devices only respond to extended linking commands"},
			{"CmdEnterUnlinkingModeExt", "Enter Unlinking Mode (extended command for I2CS devices)", "Enter Unlinking Mode (i2cs)", 0x0a, 0x00, "Insteon version 2 with checksum devices only respond to extended linking commands"},
	...
	},
	{
		...
		Commands: []command{
			...
			{"CmdLightOnAtRamp", "", "Light On At Ramp", 0x2e, 0x00, "This command is for dimmers with firmware version less than version 67"},
			{"CmdLightOnAtRampV67", "", "Light On At Ramp", 0x34, 0x00, "Dimmers running firmware version 67 and higher"},
